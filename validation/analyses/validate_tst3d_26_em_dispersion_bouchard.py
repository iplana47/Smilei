...
#Ex = np.array(S.Field.Field0("Ex", timesteps=timesteps[-1]).getData())[0]
#Ey = np.array(S.Field.Field0("Ey", timesteps=timesteps[-1]).getData())[0]
#Ez = np.array(S.Field.Field0("Ez", timesteps=timesteps[-1]).getData())[0]
#Erms = np.mean(Ez**2)**0.5
...
#Bx = np.array(S.Field.Field0("Bx", timesteps=timesteps[-1]).getData())[0]
#By = np.array(S.Field.Field0("By", timesteps=timesteps[-1]).getData())[0]
#Bz = np.array(S.Field.Field0("Bz", timesteps=timesteps[-1]).getData())[0]
