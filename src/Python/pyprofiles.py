...
def LaserEnvelopePlanar1D( a0=1., omega=1., time_envelope=tconstant(),
        envelope_solver = "explicit",envelope_initialization = "inside_the_window",Envelope_boundary_conditions = [["reflective"]],
    ...
    LaserEnvelope(
        ...
        envelope_initialization      = envelope_initialization,
...
def LaserEnvelopeGaussian3D( a0=1., omega=1., focus=None, waist=3., time_envelope=tconstant(),
        envelope_solver = "explicit",Envelope_boundary_conditions = [["reflective"]], envelope_initialization = "inside_the_window",
        polarization_phi = 0.,ellipticity = 0.):
    import cmath
    from numpy import exp, sqrt, arctan, vectorize
